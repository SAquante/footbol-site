      ...
      <main className="container mx-auto px-4 pt-20 pb-12 md:pt-32 md:pb-20">
        ...
        >
          <motion.h1
            ...
            className="text-5xl sm:text-6xl md:text-9xl font-black mb-4 md:mb-6"
          ...
          <motion.p
            className="text-base sm:text-lg md:text-2xl text-gray-400 mb-4 md:mb-8 px-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <div className="flex justify-center gap-6 md:gap-12 mb-6 md:mb-12">
            <motion.div
              className="w-16 md:w-24 h-1 bg-gradient-to-r from-real-gold to-yellow-400"
              initial={{ width: 0 }}
              animate={{ width: '4rem' }}
              transition={{ delay: 0.6, duration: 0.8 }}
            />
            <motion.div
              className="w-16 md:w-24 h-1 bg-gradient-to-r from-barca-blue to-barca-red"
              initial={{ width: 0 }}
              animate={{ width: '4rem' }}
              transition={{ delay: 0.6, duration: 0.8 }}
            />
        ...
        {nextMatch ? (
          ...
          >
            <div className="text-center mb-6 md:mb-8">
              ...
              <h2 className="inline-block ml-2 md:ml-4 text-2xl md:text-4xl">
            ...
            <div className="card max-w-5xl mx-auto relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-center mb-6 md:mb-8">
                  <div className="inline-block bg-gradient-to-r from-real-gold/20 to-barca-blue/20 border border-white/20 rounded-full px-4 py-2 md:px-8 md:py-3 mb-3 md:mb-4">
                  ...
                  <div className="text-4xl md:text-6xl font-black text-white mb-2 tracking-wider">
                    {format(new Date(nextMatch.match_datetime), 'HH:mm')}
                  </div>
                  <div className="flex items-center justify-center gap-2 text-base md:text-xl text-gray-400 px-4">
                    <span>📍</span>
                    <a 
                      href={`https://yandex.ru/maps/?text=${encodeURIComponent(nextMatch.location)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-semibold hover:text-real-gold transition-colors cursor-pointer underline break-words"
                    >
                      {nextMatch.location}
                    </a>
                  </div>
                ...
                <div className="my-8 md:my-12 relative">
                  ...
                  <div className="relative flex justify-center">
                    <motion.div
                      className="bg-dark-primary px-6 py-3 md:px-8 md:py-4"
                      whileHover={{ scale: 1.2, rotate: 360 }}
                      transition={{ duration: 0.5 }}
                    >
                      <div className="text-4xl md:text-6xl font-black bg-gradient-to-r from-real-gold via-white to-barca-blue bg-clip-text text-transparent">
                        VS
                      </div>
                    </motion.div>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                  ...
                  <motion.div
                    whileHover={{ y: -5 }}
                    className="bg-gradient-to-br from-real-gold/10 to-transparent border-2 border-real-gold/30 rounded-2xl p-4 md:p-6 relative overflow-hidden"
                  >
                    <div className="absolute top-0 right-0 text-6xl md:text-9xl opacity-5">⚪</div>
                    <div className="relative z-10">
                      <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                        <div className="text-2xl md:text-4xl">👑</div>
                        <h3 className="text-lg md:text-2xl font-black text-gradient-real">
                          РЕАЛ МАДРИД
                        </h3>
                      </div>
                      {nextMatch.lineup_real ? (
                        <div className="bg-dark-accent/50 rounded-lg p-3 md:p-4 border border-real-gold/20">
                          <p className="whitespace-pre-line text-sm md:text-base text-gray-300 leading-relaxed">
                            {nextMatch.lineup_real}
                          </p>
                        </div>
                      ) : (
                        <div className="bg-dark-accent/30 rounded-lg p-4 md:p-6 border border-dashed border-white/10 text-center">
                          <div className="text-3xl md:text-5xl mb-2 md:mb-3">⏳</div>
                          <p className="text-sm md:text-base text-gray-500 italic">Состав формируется...</p>
                        </div>
                      )}
                    </div>
                  </motion.div>
                  ...
                  <motion.div
                    whileHover={{ y: -5 }}
                    className="bg-gradient-to-br from-barca-blue/10 to-transparent border-2 border-barca-blue/30 rounded-2xl p-4 md:p-6 relative overflow-hidden"
                  >
                    <div className="absolute top-0 right-0 text-6xl md:text-9xl opacity-5">🔵</div>
                    <div className="relative z-10">
                      <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                        <div className="text-2xl md:text-4xl">🏆</div>
                        <h3 className="text-lg md:text-2xl font-black text-gradient-barca">
                          БАРСЕЛОНА
                        </h3>
                      </div>
                      {nextMatch.lineup_barca ? (
                        <div className="bg-dark-accent/50 rounded-lg p-3 md:p-4 border border-barca-blue/20">
                          <p className="whitespace-pre-line text-sm md:text-base text-gray-300 leading-relaxed">
                            {nextMatch.lineup_barca}
                          </p>
                        </div>
                ...
                <motion.div
                  ...
                  transition={{ delay: 1 }}
                >
                  <div className="inline-block bg-gradient-to-r from-real-gold/10 via-white/5 to-barca-blue/10 border border-white/20 rounded-full px-4 py-2 md:px-6 md:py-3">
          ...
          <motion.section
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-center py-12 mb-12 md:py-20 md:mb-20"
          >
            <div className="card max-w-2xl mx-auto">
              <div className="text-5xl md:text-7xl mb-4 md:mb-6">😴</div>
              <h2 className="mb-3 md:mb-4 text-xl md:text-3xl">Нет запланированных матчей</h2>
        ...
        {recentMatches.length > 0 && (
          ...
          >
            <div className="text-center mb-8 md:mb-12">
              <h2 className="mb-3 md:mb-4 text-2xl md:text-4xl">
                <span className="text-white">⚡ ПОСЛЕДНИЕ МАТЧИ</span>
              </h2>
              <p className="text-gray-400 text-sm md:text-base px-4">Результаты прошедших противостояний</p>
            </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="text-center">
                        <div className="inline-block bg-dark-accent px-3 py-1 rounded-full">
                          <div className="text-xs text-gray-400 flex items-center gap-1 flex-wrap justify-center">
                            <span>📍</span>
                            <a 
                              href={`https://yandex.ru/maps/?text=${encodeURIComponent(match.location)}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="hover:text-real-gold transition-colors cursor-pointer underline break-words max-w-full"
                            >
                              {match.location}
                            </a>
                          </div>
          ...
          >
            <div className="card max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-3 gap-3 md:gap-6 mb-6 md:mb-8">
                ...
                >
                  <div className="text-3xl md:text-6xl font-black text-gradient-real mb-1 md:mb-2">
                    {((realWins / completedMatches.length) * 100).toFixed(0)}%
                  </div>
                  <div className="text-xs md:text-sm text-gray-400">Процент побед Реала</div>
                </motion.div>
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.1 }}
                >
                  <div className="text-3xl md:text-6xl font-black text-white mb-1 md:mb-2">
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.1 }}
                >
                  <div className="text-3xl md:text-6xl font-black text-gradient-barca mb-1 md:mb-2">
                    {((barcaWins / completedMatches.length) * 100).toFixed(0)}%
                  </div>
                  <div className="text-xs md:text-sm text-gray-400">Процент побед Барсы</div>
                </motion.div>
              </div>

              <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
                <div className="bg-gradient-to-br from-real-gold/10 to-transparent border border-real-gold/30 rounded-xl p-4 md:p-6">
                  <div className="text-xs md:text-sm text-gray-400 mb-2">Средний счёт Реала</div>
                  <div className="text-3xl md:text-4xl font-black text-gradient-real">
                    {(totalRealGoals / completedMatches.length).toFixed(1)}
                  </div>
                  <div className="text-xs text-gray-500 mt-1">голов за матч</div>
                </div>

                <div className="bg-gradient-to-br from-barca-blue/10 to-transparent border border-barca-blue/30 rounded-xl p-4 md:p-6">
                  <div className="text-xs md:text-sm text-gray-400 mb-2">Средний счёт Барсы</div>
                  <div className="text-3xl md:text-4xl font-black text-gradient-barca">
              ...
              {(realWins > barcaWins || barcaWins > realWins) && (
                <motion.div
                  className="mt-4 md:mt-6 text-center p-3 md:p-4 bg-gradient-to-r from-transparent via-white/5 to-transparent rounded-lg"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 1 }}
                >
                  <div className="text-xs md:text-sm text-gray-400 mb-2">🔥 Лидер противостояния</div>
        ...
        >
          <div className="card max-w-3xl mx-auto bg-gradient-to-r from-real-gold/5 via-transparent to-barca-blue/5 border-2 border-white/20">
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-white px-4">
              Стань частью легенды!
            </h3>
            <p className="text-gray-400 text-sm md:text-lg mb-4 md:mb-6 px-4">
              Следи за всеми матчами, поддерживай свою команду<br className="hidden sm:block"/>
              и будь в курсе самых жарких моментов El Clásico
            </p>
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
              <motion.a
                href="/schedule"
                className="btn-real py-3 px-6 text-center"
              ...
              <motion.a
                href="/login"
                className="btn-barca py-3 px-6 text-center"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                🔐 Админка
